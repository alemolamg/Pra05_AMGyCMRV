...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pra05.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pra05.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pra05 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/EcoCityMoto.o: EcoCityMoto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EcoCityMoto.o EcoCityMoto.cpp
...
${OBJECTDIR}/Moto.o: Moto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Moto.o Moto.cpp

${OBJECTDIR}/THashCliente.o: THashCliente.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/THashCliente.o THashCliente.cpp
